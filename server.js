...
console.log("Hello acces id "+process.env.ACCESS_KEY_ID);
...
app.use(function(req,res,next){
    ...
    if(req.user){
      ...
      // Instructor.findOne({ _id:req.user }, (err, foundItems) => {
      //   if(foundItems){
      //     // var instructordata=foundItems;
      //     res.locals.instructordata=foundItems;  // Global variable to access authorized user data 
      //     // console.log(instructordata)
      //   }
      //   else{
      //     User.findOne({ _id:req.user }, (err, foundItems) => {
      //       res.locals.userdata=foundItems;
            
      //         // console.log(userdata);
      //     })
      //   }
      // })
      // console.log("data=  "+req.username);
